  ...
  return (
    <AccountWrapper>
      <div className="text-center m-auto">
        ...
        <h4 className="text-dark text-center mt-3 fw-bold">Por favor revise su correo electrónico</h4>
        <p className="text-dark text-opacity-75 mb-3">
          Se ha enviado un correo electrónico a &nbsp;<b>{email}</b>.&nbsp; Verifique si recibió un correo electrónico y

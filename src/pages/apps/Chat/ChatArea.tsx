	...
	return (
		<Card className="h-100 overflow-hidden mb-0">
			...
			<CardBody className="p-0 pt-3">
				<SimpleBar
					className="conversation-list px-3 chat-conversation"
					style={{ height: '538px', width: '100%' }}
				>
					{userMessages.map((message, index) => {
						return (
							<UserMessage key={index.toString()} message={message} toUser={toUser} />
						);
					})}
				...
				>
					<div className="d-flex align-items-start">
						...
						<div className="btn-group">
							<Link to="" className="btn btn-light d-none d-md-inline-block">

...
export const GESTION_USUARIOS_MENU_KEY = '/services/gestion/usuarios';
export const GESTION_NOTICIAS_MENU_KEY = '/services/gestion/noticias';

export const GESTION_OFICINA_MENU_KEY = '/services/gestion/oficina';
export const GESTION_OFICINA_CALENDARIO_MENU_KEY = '/services/gestion/oficina/calendario';

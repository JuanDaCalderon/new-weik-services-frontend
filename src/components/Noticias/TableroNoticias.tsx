...
const TableroNoticias = memo(function TableroNoticias() {
  ...
  const slidesPerView = useMemo(() => {
    if (!isWideDesktop) return isMobile ? 1 : 2;
    return isExpanded ? 3 : isHugeScreen ? 6 : 5;
  }, [isExpanded, isHugeScreen, isMobile, isWideDesktop]);
        ...
        <Card className="mb-2">
          <Card.Body className="position-relative">
            ...
            {isLoadingNews ? (
              ...
              <Swiper
                style={{height: `calc(${!isWideDesktop ? 36 : 75}vh - var(--ct-topbar-height))`}}
                ...
                mousewheel={true}
                direction={!isWideDesktop ? 'horizontal' : 'vertical'}
